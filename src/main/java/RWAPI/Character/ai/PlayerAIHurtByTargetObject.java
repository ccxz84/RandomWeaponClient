...
public class PlayerAIHurtByTargetObject extends EntityAIBase {
	...
	public PlayerAIHurtByTargetObject(EntityCreature creature, boolean checkSight)
	{
		this(creature, checkSight, false);
	}

	public PlayerAIHurtByTargetObject(EntityCreature creature, boolean checkSight, boolean onlyNearby)
	{
	...
	public boolean shouldExecute() {
		...
		if(taskOwner.getAttackingEntity() instanceof EntityPlayerMP) {
			taskOwner.setAttackTarget(taskOwner.getAttackingEntity());
		}
		if(taskOwner.getAttackingEntity() == null) {
	...
	{
		System.out.println("isSuitableTarget1");
	...
	public PlayerAIHurtByTargetObject setUnseenMemoryTicks(int p_190882_1_)
	{
