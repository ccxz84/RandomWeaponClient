...
public class RenderBlazingpalm extends Render<EntityBlazingpalm>{

	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":textures/entity/blazingpalm.png");

	protected RenderBlazingpalm(RenderManager renderManager) {
		super(renderManager);
		// TODO Auto-generated constructor stub
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityBlazingpalm entity) {
		// TODO Auto-generated method stub
		return TEXTURE;
	}

	@Override
	public void doRender(EntityBlazingpalm entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	public static class Factory implements IRenderFactory<EntityBlazingpalm> {
		@Override
		public Render<? super EntityBlazingpalm> createRenderFor(RenderManager manager) {
			return new RenderBlazingpalm(manager);
		}
	}
