...
public class RenderSnowball extends Render<EntitySnowball>{
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":textures/entity/snowball.png");

	protected RenderSnowball(RenderManager renderManager) {
		super(renderManager);
	...
	@Override
	public void doRender(EntitySnowball entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	public static class Factory implements IRenderFactory<EntitySnowball> {
		@Override
		public Render<? super EntitySnowball> createRenderFor(RenderManager manager) {
