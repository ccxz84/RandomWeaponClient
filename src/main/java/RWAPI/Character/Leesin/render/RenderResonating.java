...
public class RenderResonating extends Render<EntityResonating>{
	...
	protected RenderResonating(RenderManager renderManager) {
		super(renderManager);
		// TODO Auto-generated constructor stub
	}
	
	@Override
	public void doRender(EntityResonating entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityResonating entity) {
		// TODO Auto-generated method stub
		return TEXTURE;
	}
	
	public static class Factory implements IRenderFactory<EntityResonating> {
		@Override
		public Render<? super EntityResonating> createRenderFor(RenderManager manager) {
			return new RenderResonating(manager);
		}
	}
